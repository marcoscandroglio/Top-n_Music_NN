...
get_file_button = tk.Button(window, text="Open Music File", command=open_music_file)
get_file_button.pack()
url_explain = tk.Label(window, text="Or use a YouTube URL").pack()
url_input = tk.Entry(window)
url_input.pack()
get_url_button = tk.Button(window, text="Open YouTube URL", command=open_url).pack()
