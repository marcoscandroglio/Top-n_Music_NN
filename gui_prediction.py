...
url_explain = tk.Label(window, text="Or use a YouTube URL", font=("Times New Roman", 16)).pack()
url_input = tk.Entry(window, width=50, font=("Times New Roman", 16))
url_input.pack()
get_url_button = tk.Button(window, text="Open YouTube URL", command=open_url, font=("Times New Roman", 16)).pack()
...
user_genre_number_label = tk.Label(window, text=genre_number_label_text, font=("Times New Roman", 16)).pack()
